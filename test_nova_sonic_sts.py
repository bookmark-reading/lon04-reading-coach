...
class SimpleNovaSonic:
    ...
    async def start_session(self):
        ...
        system_prompt = "You are a friendly assistant. The user is a child trying to read a book with the words 'the cat sat on the hat. the dog sat on the book, the mouse sat on the phone' and I need you to give feedback on their reading. do minor corrections and wait until the end of the page, or if the child is struggling you can give small prompts. don't say too much"
